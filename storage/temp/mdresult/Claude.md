...
- icon: •
  tag: Claude Opus
  title: 최고 성능
  desc: 복잡한 분석, 장문 보고서, 다단계 추론에 최적. 가장 강력하지만 응답 속도가 느림.
  meta: 🧠 복잡한 분석|📄 장문 작성|🔬 연구
- icon: •
  tag: Claude Sonnet ⭐ 추천
  title: 균형 잡힌 선택
  desc: 성능과 속도의 황금비율. 일상 업무, 코딩, 문서 작성에 가장 적합. 대부분의 상황에서 최선.
  meta: 💼 업무 자동화|💻 코딩|✍️ 문서 작성
- icon: •
  tag: Claude Haiku
  title: 빠른 응답
  desc: 단순 요약, 분류, 빠른 Q&A에 최적화. API 활용 및 대량 처리에 비용 효율적.
  meta: ⚡ 빠른 응답|📊 분류/요약|🔄 API 처리
:::
