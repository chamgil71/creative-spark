---
title: Google Gemini 완전 활용 가이드
subtitle: Google의 멀티모달 AI — 텍스트·이미지·영상·음성을 한 번에 처리하는 차세대 AI
logo: Gemini
...
- title: Gems 시스템 지침 예시 — 업무 보고서 작성 에이전트
  desc: 역할: 당신은 한국 공공기관 전문 보고서 작성 AI입니다. 능력: - Google Drive에서 관련 문서를 검색하여 참고 - 최신 정책 동향을 Google 검색으로 확인 - 표·차트를 포함한 구조화된 보고서 작성 출력 형식: 1. 개요 (3줄 이내) 2. 현황 분석 (표 포함) 3. 시사점 및 제언 # Gems는 claude.ai의 프로젝트와 유사한 개인화 에이전트
:::
