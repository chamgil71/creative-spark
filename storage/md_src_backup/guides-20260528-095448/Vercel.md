...
subtitle: 전 세계에서 가장 빠른 웹 배포와 강력한 개발자 경험을 제공하는 클라우드 플랫폼
logo: ▲
...
stats:
  ...
  title: 당신의 프로젝트를 세계로 연결하세요
  subtitle: GitHub에 커밋하는 순간, 전 세계 어디서나 접속 가능한 가장 빠른 웹사이트가 완성됩니다.
  ctaLabel: 배포 시작하기
  ctaUrl: https://vercel.com/new
footer:
  - Vercel은 프론트엔드 프레임워크 Next.js의 개발사가 직접 운영하는 최적화 배포 플랫폼입니다.
  - "공식 사이트: [vercel.com](https://vercel.com)"
---
...
- 도메인 연결 시 `www` 여부와 리다이렉트 설정이 올바른가
