...
subtitle: "도메인, 보안, CDN부터 홈 서버 터널링까지 한 번에 해결하는 글로벌 인프라 플랫폼"
style: "ai-dev"
badge: "☁️ 인프라 · 보안 및 배포"
logo: "🌩️"
heroCta:
  label: "Cloudflare 시작하기"
...
stats:
  ...
  title: "가장 안전하고 빠른 인프라를 구축하세요"
  subtitle: "내 도메인의 네임서버를 연결하는 순간, 디도스 방어와 트래픽 가속이 자동으로 시작됩니다."
  ctaLabel: "대시보드 이동"
  ctaUrl: "https://dash.cloudflare.com"
footer:
  - "Cloudflare는 전 세계 인터넷 트래픽의 상당 부분을 처리하는 엣지 컴퓨팅 리더입니다."
  - "공식 사이트: [cloudflare.com](https://www.cloudflare.com)"
---

# 1. Cloudflare는 어떤 도구인가
...
> 💡 **TIP**: Docker를 사용해 미니 PC 등에서 자동화 노드(n8n 등)나 개인용 앱을 구동 중이라면, 컨테이너 내부에 `cloudflared`를 설치하여 Tunnels를 연결해보세요. 로컬 IP(`localhost:5678`)를 `n8n.my-domain.com`으로 즉시 매핑할 수 있습니다.
